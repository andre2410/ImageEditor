...
public class MeanFilter implements ImageOperation, java.io.Serializable {
     ...
     * to account for border - the image was increaed in size by the radius with thte original placed centerd on top of it so that the bordering colours would match. 
    ...
    public String toString(){
        return "Mean filter with radius of " + radius;
    }
}
