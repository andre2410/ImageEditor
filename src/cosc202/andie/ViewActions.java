...
public class ViewActions {
    ...
    public JMenu createMenu() {
        ...
        JMenuItem zoomIn = new JMenuItem(actions.get(0));
        zoomIn.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, ActionEvent.CTRL_MASK));
        viewMenu.add(zoomIn);

        JMenuItem zoomOut = new JMenuItem(actions.get(1));
        zoomOut.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, ActionEvent.CTRL_MASK));
        viewMenu.add(zoomOut);

        JMenuItem zoomFull = new JMenuItem(actions.get(2));
        zoomFull.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_1, ActionEvent.CTRL_MASK));
        viewMenu.add(zoomFull);
    ...
    public class ZoomInAction extends ImageAction {
        ...
        public void actionPerformed(ActionEvent e) {
            if(!target.getImage().hasImage()){
                Popup p = new Popup("Zoom error", "Please open an image first");
                p.show();
                return;
            }
